...
export default function LoginBtn({onLoginCLick}) {
  return(
    <button
      type={BtnType.BTN}
      className={styles.login}
      onClick={onLoginCLick}>
        <svg className={styles.login__img} width='20' height='22' viewBox='0 0 20 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
        ...
        <p className={styles.text}>Войти в Интернет-банк</p>
    </button>
  );
}
